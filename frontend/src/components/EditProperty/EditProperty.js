...
class EditProperty extends Component {
  constructor(props) {
    super(props);
    const { propertyID, property, changeDate } = this.props.location.state;
    ...
    this.state = {
      ...
      paid: property.parking.paid,
      dailyFee: property.parking.dailyFee,
      bedroomCount: property.bedroomCount,
      rentWeekday: property.rentWeekday,
      rentWeekend: property.rentWeekend,
      selectImages: false,
      available: false,
      alwaysAvailable: false,
      privateBathAvailable: property.privateBathAvailable,
      privateShowerAvailable: property.privateShowerAvailable,
      images: "",
      isUploaded: "",
      dataEdited: "",
      finalImages: "",
    ...
    this.handleAvailSubmit = this.handleAvailSubmit.bind(this);
  }
  handleChange = e => {
    console.log("e ka target file", e.target.files);
    if (e.target.files[0]) {
      const images = Array.from(e.target.files);
      this.setState({ images: images, selectImages: true }, () => {
  ...
  handleEditProperty = e => {
    e.preventDefault();
    const requestBody = {
      propertyID: this.state.propertyID.toString(),
      user: {
    ...
    console.log("REQ BODY EDIT PROP", requestBody);
  ...
  handleAvailSubmit = e => {
    ...
    var changeTemp = this.state.changeDate;

    var changeDateResult = changeTemp.substring(0, 10);

    console.log("change date result: ", changeDateResult);
    ...
    const requestBody = {
      ...
      changeDate: changeDateResult //this.state.changeDate
    };
    console.log("REQ BODY AVAIL SUBMIT", requestBody);

    axios
      .put(API_ENDPOINT + "/posting/availability", requestBody)
      .then(response => {
        if (response.status == 200) {
          window.alert("Property Availability Changed Successfully!");
          ...
          <div class="container-fluid">
            ...
            <div class="row" style={{ "margin-top": "8%" }}>
              <div class="col-lg-4 col-md-6 col-sm-6 ">
                <div class="card ml-5 w-55">
                  <div class="card-body">
                    {/* AVAILABILITY BODY */}
                    <h5 class="card-title">
                      <hr />
                      Change availability <i class="fas fa-info-circle"></i>
                      <hr />
                    </h5>

                    <p>
                      <b>Select new availability</b>
                    </p>
                    ...
                    <button
                      ...
                      onClick={this.handleAvailSubmit}
                    >
                      Change Availability
                    </button>
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 ">
                ...
                >
                  ...
                  <b class="mt-4 ml-4"> EDIT PROPERTY </b>
                  <hr />
                  <div class="row"></div>
                  <div class="card-body">
                    <form>
