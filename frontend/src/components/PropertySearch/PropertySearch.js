...
class PropertySearch extends Component {
  ...
  render() {
    let count = this.state.properties.length;
    ...
    //PROPERTY CARD CODE:
    let propertyCard = paginatedproperties.map(property => {
      ...
      var nameArr = property.images.split(",");
          ...
          <div class="card mb-3 ml-4" style={{ "max-width": "540px" }}>
            <div class="row no-gutters">
              <div class="col-md-4">
                <img
                  class="card-img"
                  src={image} // replace with {property.images[0]}
                  style={{ height: "15rem" }}
                />{" "}
              </div>
              <div class="col-md-8">
